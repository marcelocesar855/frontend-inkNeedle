...
export default class PerfilEstudio extends Component {
   ...
   async getPosts(studioId) {
    ...
    handleInputChangeAvatar = e => { 
        this.setState({
            selectedAvatarFile: e.target.files[0]
        })
    }

    handleInputChangeBanner = e => { 
        this.setState({
    ...
    render() {
        return (
            <div className="wrapper wrapper-logado">
                ...
                <div class="modal fade" id="uploadAvatar" tabindex="-1" role="dialog" aria-labelledby="TituloModalCentralizado" aria-hidden="true">
                                ...
                                <div className="form-group files">
                                    <p>
                                        <input type="file" multiple=""
                                            onChange={this.handleInputChangeAvatar}></input>
                                    </p>
                                </div>
                            </div>
                ...
                <div class="modal fade" id="uploadBanner" tabindex="-1" role="dialog" aria-labelledby="TituloModalCentralizado" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
